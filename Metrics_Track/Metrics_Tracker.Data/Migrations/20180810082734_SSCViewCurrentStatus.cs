namespace Metrics_Track.Data.Migrations
{
    ...
    public partial class SSCViewCurrentStatus : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            currentStatusView.Append("FROM (SELECT [CPS].[tbl_UserActivity].[ID_Login],[Display Name],[TeamLead],[Type],[ChangeStamp],[Comment],[CPS].[tbl_UserActivity].[Sandbox]," + Environment.NewLine);
            ...
            currentStatusView.Append("FROM CPS.tbl_Login" + Environment.NewLine);
            currentStatusView.Append("RIGHT OUTER JOIN CPS.tbl_UserActivity ON CPS.tbl_Login.ID_Login = CPS.tbl_UserActivity.ID_Login" + Environment.NewLine);
            currentStatusView.Append("WHERE[ChangeStamp] >= DATEADD(mm, - 3, Getdate())) R" + Environment.NewLine);
            currentStatusView.Append("WHERE r.time_rank = 1" + Environment.NewLine);
